...
export class ERC721HmyManager extends ethereum.SmartContract {
  static bind(address: Address): ERC721HmyManager {
    return new ERC721HmyManager("ERC721HmyManager", address);
  }
