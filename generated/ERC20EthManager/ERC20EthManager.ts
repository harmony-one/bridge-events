...
export class ERC20EthManager extends ethereum.SmartContract {
  static bind(address: Address): ERC20EthManager {
    return new ERC20EthManager("ERC20EthManager", address);
  }
