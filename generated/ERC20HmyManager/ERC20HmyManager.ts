...
export class ERC20HmyManager extends ethereum.SmartContract {
  static bind(address: Address): ERC20HmyManager {
    return new ERC20HmyManager("ERC20HmyManager", address);
  }
